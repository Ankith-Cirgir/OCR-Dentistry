...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -DDARWIN_NO_CARBON   -I/opt/homebrew/Cellar/libpng/1.6.44/include/libpng16 -pthread \
...
# Linker flags.
#
LDFLAGS :=  -lz -lbz2 -L/opt/homebrew/Cellar/libpng/1.6.44/lib -lpng16 -pthread -lpthread
